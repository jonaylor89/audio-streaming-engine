...
fn generate_test_urls() -> Vec<(&'static str, String)> {
    vec![
        ...
        (
            "high_complexity",
            "audio/track.mp3?format=flac&sample_rate=96000&channels=2&bit_depth=24&volume=0.8&normalize=true&lowpass=20000&highpass=20&echo=0.8:0.88:60:0.4&compressor=threshold=0.125:ratio=6:attack=20:release=250:makeup=1&fade_in=2.0&fade_out=3.0".to_string(),
        ),
    ...
    vec![
        ...
        ("all_filters", {
            ...
            map.insert(
                ...
                "threshold=0.125:ratio=6:attack=20:release=250:makeup=1".to_string(),
            );
