...
mod real_fixture_processing {
    ...
    fn passthrough_fixture_mp3(bencher: Bencher<'_, '_>) {
    ...
    #[divan::bench(ignore = cfg!(codspeed))]
    fn transcode_fixture_mp3_to_wav(bencher: Bencher<'_, '_>) {
        let processor = build_processor();
        let rt = tokio::runtime::Runtime::new().unwrap();
        let params = Params {
            key: "sample1.mp3".to_string(),
    ...
    #[divan::bench(ignore = cfg!(codspeed))]
    fn metadata_only_fixture_mp3(bencher: Bencher<'_, '_>) {
        let processor = build_processor();
        let rt = tokio::runtime::Runtime::new().unwrap();
        let params = Params {
            key: "sample1.mp3".to_string(),
            tags: Some(HashMap::from([
                ("artist".to_string(), "Benchmark Artist".to_string()),
                ("title".to_string(), "Benchmark Title".to_string()),
            ])),
            ..Default::default()
        };
    ...
    #[divan::bench(ignore = cfg!(codspeed))]
    fn filter_fixture_mp3(bencher: Bencher<'_, '_>) {
        let processor = build_processor();
        let rt = tokio::runtime::Runtime::new().unwrap();
        let params = Params {
            key: "sample1.mp3".to_string(),
