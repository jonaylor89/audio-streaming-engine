...
MCP (Model Context Protocol) server for [streaming-engine](https://github.com/jonaylor89/audio-streaming-engine/tree/main/streaming-engine) - Connect LLMs like Claude to your audio processing server.
